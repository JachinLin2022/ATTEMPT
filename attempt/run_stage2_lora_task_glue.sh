...
do
    ...
    do
        ...
        output_dir="/home/linzhisheng/ATTEMPT/attempt/result/stage2_no_prefix_with_task_moe_loss_6lora/"$learning_rate"_"$task"_"$per_device_train_batch_size"_"$task_reduction_factor
...
# task_reduction_factor=16
# target_task=(superglue-cb cola superglue-wsc-fixed mrpc stsb rte superglue-wic superglue-boolq superglue-multirc)
# target_task=(winogrande paws yelp_polarity scitail)
# for task in ${target_task[@]}
# do
#     for learning_rate in ${lrs[@]}
#     do
