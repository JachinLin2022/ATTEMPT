...
do
    ...
    do
        ...
        output_dir="/home/linzhisheng/ATTEMPT/attempt/result/mixda/"$learning_rate"_"$task"_"$per_device_train_batch_size"_"$CUDA_VISIBLE_DEVICES
...
# target_task=(yelp_polarity paws scitail winogrande superglue-multirc nq newsqa searchqa hotpotqa)
# for task in ${target_task[@]}
# do
#     for learning_rate in ${lrs[@]}
#     do
