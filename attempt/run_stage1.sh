...
report_to="none"
add_lora=false
# target_task=(superglue-multirc superglue-cb superglue-wic superglue-wsc superglue-boolq)
target_task=(cola rte mrpc stsb)
big_task=(superglue-multirc superglue-boolq)
small_task=(superglue-cb)
...
do
    ...
    output_dir="outputs/task_adapter/adapter_"$task
